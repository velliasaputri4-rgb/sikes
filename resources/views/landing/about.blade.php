...
<body>
    ...
    <section class="section">
        <div class="container">
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    <img src="https://img.freepik.com/free-vector/healthcare-concept-illustration_23-2148939760.jpg" class="img-fluid rounded-4 shadow-sm" alt="Ilustrasi Kesehatan">
                </div>
                <div class="col-lg-6">
    ...
    <!-- Footer (Sama Persis dengan Halaman Kontak) -->
    <footer>
        <div class="container">
            <div class="row g-4">
                <!-- Kolom 1: Tentang -->
