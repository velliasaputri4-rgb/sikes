...
<head>
    ...
    * { -webkit-font-smoothing: antialiased; }
    ...
    .stat-mini-icon.bg-available { background: linear-gradient(135deg, #10b981, #14b8a6); }
    ...
    .stock-bar-fill.bar-available { background: linear-gradient(90deg, #10b981, #14b8a6); }
