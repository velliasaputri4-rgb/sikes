        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center gap-1">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{ route('landing.services') }}">Layanan</a></li>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                @else
                                    ...
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item fw-semibold" href="{{ route('login') }}"><i class="fas fa-user-shield me-2 text-primary"></i> Admin</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" href="{{ route('login.siswa') }}"><i class="fas fa-user-graduate me-2 text-info"></i> Login Siswa</a></li>
                                @endauth
                            </ul>
                        </div>
                    </li>
    ...
    <section class="section" style="background: #f8fafc;">
        <div class="container">
            <div class="text-center mb-5" data-aos="fade-up">
                ...
                <h2 class="section-title">{!! \App\Models\Setting::get('faq_title', 'Pertanyaan yang <span class="gradient-text">Sering Diajukan</span>') !!}</h2>
                <p class="section-subtitle mx-auto">{{ \App\Models\Setting::get('faq_subtitle', 'Temukan jawaban atas pertanyaan umum seputar layanan UKS dan penggunaan aplikasi SIKES di sekolah kita.') }}</p>
            </div>
