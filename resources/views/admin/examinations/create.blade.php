...
<div class="content-card">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="fw-bold mb-0"><i class="fas fa-plus-circle text-primary me-2"></i>Form Pemeriksaan Baru</h5>
            ...
            <div class="col-lg-7">
                <div class="p-3 bg-light rounded-3 mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="medicine" class="form-control" placeholder="Contoh: Paracetamol 500mg (2 tablet), Vitamin C (1 tablet)" value="{{ old('medicine') }}">
                    </div>
...
<script>
    ...
    // ✅ PERBAIKAN: Gunakan url() alih-alih route() agar tidak error missing parameter {nis}
    const searchBaseUrl = "{{ url('petugas/examinations/cari-siswa') }}";
    ...
    async function cariSiswa(nis) {
        ...
        try {
            // ✅ PERBAIKAN: Gabungkan base URL dengan NIS
            const response = await fetch(`${searchBaseUrl}/${nis}`);
