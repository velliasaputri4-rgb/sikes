...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('petugas.examinations.recap') ? 'active' : '' }}" href="{{ route('petugas.examinations.recap') }}">
        ...
        <div class="sidebar-profile">
            <div class="sidebar-profile-content">
                <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&background=ef4444&color=ffffff&bold=true" 
                     alt="{{ auth()->user()->name }}" 
    ...
    <div class="main-content" id="mainContent">
        <div class="topbar">
            ...
            {{-- ✅ TOMBOL BERANDA - KANAN --}}
            <div>
                <a href="{{ route('landing') }}" class="btn btn-sm btn-light border text-danger fw-semibold" title="Kembali ke Beranda" style="border-color: #fecaca !important;">
