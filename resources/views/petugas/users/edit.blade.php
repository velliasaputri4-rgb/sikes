...
<div class="content-card">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="fw-bold mb-0"><i class="fas fa-user-edit me-2 text-primary"></i>Edit Data User</h5>
    ...
    <form action="{{ route('petugas.users.update', $user->id) }}" method="POST">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                <small class="text-muted">Pilih peran yang sesuai untuk pengguna ini.</small>
            </div>
        </div>
