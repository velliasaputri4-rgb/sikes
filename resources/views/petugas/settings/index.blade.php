                ...
                <div class="card border-0 shadow-sm mb-3">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                <label class="form-label fw-semibold">Judul Section</label>
                                <input type="text" name="about_page_values_title" class="form-control" value="{{ $settings['about_page_values_title'] ?? 'Mengapa Memilih SIKES?' }}">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Subjudul Section</label>
                                <textarea name="about_page_values_subtitle" class="form-control" rows="2">{{ $settings['about_page_values_subtitle'] ?? 'Empat pilar utama yang menjadi fondasi pengembangan sistem kami.' }}</textarea>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="value_card_1_title" class="form-control" value="{{ $settings['value_card_1_title'] ?? 'Data Digital' }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Icon Kartu 1 (FontAwesome)</label>
                                <input type="text" name="value_card_1_icon" class="form-control" value="{{ $settings['value_card_1_icon'] ?? 'fa-database' }}" placeholder="fa-database">
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold">Deskripsi Kartu 1</label>
                                <textarea name="value_card_1_desc" class="form-control" rows="2">{{ $settings['value_card_1_desc'] ?? 'Tidak ada lagi berkas kertas yang hilang. Seluruh riwayat kesehatan tersimpan aman di sistem.' }}</textarea>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="value_card_2_title" class="form-control" value="{{ $settings['value_card_2_title'] ?? 'Terintegrasi' }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Icon Kartu 2 (FontAwesome)</label>
                                <input type="text" name="value_card_2_icon" class="form-control" value="{{ $settings['value_card_2_icon'] ?? 'fa-link' }}" placeholder="fa-link">
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold">Deskripsi Kartu 2</label>
                                <textarea name="value_card_2_desc" class="form-control" rows="2">{{ $settings['value_card_2_desc'] ?? 'Hubungan yang mulus antara data siswa, stok obat, dan jadwal petugas dalam satu dashboard.' }}</textarea>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="value_card_3_title" class="form-control" value="{{ $settings['value_card_3_title'] ?? 'Efisien' }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Icon Kartu 3 (FontAwesome)</label>
                                <input type="text" name="value_card_3_icon" class="form-control" value="{{ $settings['value_card_3_icon'] ?? 'fa-bolt' }}" placeholder="fa-bolt">
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold">Deskripsi Kartu 3</label>
                                <textarea name="value_card_3_desc" class="form-control" rows="2">{{ $settings['value_card_3_desc'] ?? 'Proses pencatatan kunjungan yang cepat dan laporan otomatis yang menghemat waktu.' }}</textarea>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="value_card_4_title" class="form-control" value="{{ $settings['value_card_4_title'] ?? 'Terpercaya' }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-semibold">Icon Kartu 4 (FontAwesome)</label>
                                <input type="text" name="value_card_4_icon" class="form-control" value="{{ $settings['value_card_4_icon'] ?? 'fa-shield-alt' }}" placeholder="fa-shield-alt">
                            </div>
                            <div class="col-12">
                                <label class="form-label small fw-semibold">Deskripsi Kartu 4</label>
                                <textarea name="value_card_4_desc" class="form-control" rows="2">{{ $settings['value_card_4_desc'] ?? 'Keamanan data privasi siswa adalah prioritas utama kami dengan standar enkripsi tinggi.' }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
