...
@section('content')
    ...
    <div class="content-card">
        <div class="page-head">
            <div>
                <h5>
                    <span class="head-icon"><i class="fas fa-user-pen"></i></span> 
                    Edit Data Siswa
                </h5>
        ...
        <form method="POST" action="{{ route('petugas.students.update', $student->id) }}" class="form-card">
            ...
            <div class="mb-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="class_name" list="daftar-kelas-edit" class="form-control" value="{{ old('class_name', $student->class->name ?? '') }}" required>
                    ...
                    <div class="datalist-hint">
                        ...
                        <span>Pilih dari daftar atau ketik nama kelas baru.</span>
                    </div>
                </div>
            ...
            <div class="d-flex gap-2 pt-3" style="border-top: 1px solid #fee2e2;">
                ...
                <a href="{{ route('petugas.students.index') }}" class="btn" style="background: #f1f5f9; color: #475569; border: 1px solid #cbd5e1;">
