...
@section('content')
    ...
    <div class="content-card">
        <div class="page-head">
            <div>
                <h5><span class="head-icon"><i class="fas fa-user-pen"></i></span> Edit Data Siswa</h5>
                <small class="text-muted">Perbarui data siswa</small>
            </div>
            <a href="{{ route('petugas.students.index') }}" class="btn btn-outline-secondary"><i class="fas fa-arrow-left me-1"></i> Kembali</a>
        </div>
