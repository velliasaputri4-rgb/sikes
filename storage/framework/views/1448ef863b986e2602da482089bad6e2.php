...
<div class="content-card">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <div>
            <a href="<?php echo e(route('petugas.examinations.edit', $examination->id)); ?>" class="btn btn-sm me-2" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: white; border: none; box-shadow: 0 4px 12px rgba(245, 158, 11, 0.3);">
        ...
        <div class="col-lg-5">
            ...
            <div class="p-4 rounded-3 mb-3" style="background: #ffffff; border: 1px solid #fee2e2; box-shadow: 0 2px 8px rgba(239, 68, 68, 0.04);">
                ...
                <div class="mb-3">
                    ...
                    <div class="fw-semibold" style="color: #0f172a;"><?php echo e($examination->examination_number); ?></div>
                </div>

                <div class="row g-3 mb-3">
                    <div class="col-6">
                        <label class="form-label small text-muted">Tanggal</label>
                        <div class="fw-semibold" style="color: #0f172a;"><?php echo e(\Carbon\Carbon::parse($examination->examination_date)->format('d/m/Y')); ?></div>
                    </div>
                    <div class="col-6">
                        <label class="form-label small text-muted">Jam Kedatangan</label>
                        <div class="fw-semibold" style="color: #0f172a;"><?php echo e(\Carbon\Carbon::parse($examination->arrival_time)->format('H:i')); ?> WIB</div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div>
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isPerluPerhatian): ?>
            ...
            <div class="p-4 rounded-3 mb-3" style="background: #ffffff; border: 1px solid #fee2e2; box-shadow: 0 2px 8px rgba(239, 68, 68, 0.04);">
                ...
                <div class="mb-2">
                    ...
                    <div class="fw-semibold" style="color: #0f172a;"><?php echo e($examination->student->nis ?? '-'); ?></div>
                </div>

                <div class="mb-2">
                    <label class="form-label small text-muted">Nama Lengkap</label>
                    <div class="fw-semibold" style="color: #0f172a;"><?php echo e($examination->student->full_name ?? '-'); ?></div>
                </div>
            ...
            <div class="p-4 rounded-3 mb-3" style="background: #ffffff; border: 1px solid #fee2e2; box-shadow: 0 2px 8px rgba(239, 68, 68, 0.04);">
                ...
                <div class="mb-2">
                    ...
                    <div class="fw-semibold" style="color: #0f172a;"><?php echo e($examination->piket_group ?? '-'); ?></div>
                </div>

                <div class="mb-2">
                    <label class="form-label small text-muted">Nama Petugas</label>
                    <div class="fw-semibold" style="color: #0f172a;"><?php echo e($examination->officer_name ?? '-'); ?></div>
                </div>
            </div>
        </div>
            ...
            <div class="p-4 rounded-3" style="background: #ffffff; border: 1px solid #fee2e2; box-shadow: 0 2px 8px rgba(239, 68, 68, 0.04);">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="fw-semibold" style="color: #0f172a;"><?php echo e($examination->created_at->format('d/m/Y H:i')); ?></div>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-muted">Terakhir Diubah</label>
                        <div class="fw-semibold" style="color: #0f172a;"><?php echo e($examination->updated_at->format('d/m/Y H:i')); ?></div>
                    </div>
                </div>
            </div>
        </div>
