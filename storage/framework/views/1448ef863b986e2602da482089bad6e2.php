...
<?php $__env->startSection('page-title', 'Detail Kunjungan Siswa'); ?>
...
<div class="content-card">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="<?php echo e(route('petugas.examinations.edit', $examination->id)); ?>" class="btn btn-warning btn-sm text-white me-2">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-5">
            ...
            <div class="p-3 bg-light rounded-3 mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="fw-semibold"><?php echo e($examination->examination_number); ?></div>
                </div>

                <div class="row g-3 mb-3">
                    <div class="col-6">
                        <label class="form-label small text-muted">Tanggal</label>
                        <div class="fw-semibold"><?php echo e(\Carbon\Carbon::parse($examination->examination_date)->format('d/m/Y')); ?></div>
                    </div>
                    <div class="col-6">
                        <label class="form-label small text-muted">Jam Kedatangan</label>
                        <div class="fw-semibold"><?php echo e(\Carbon\Carbon::parse($examination->arrival_time)->format('H:i')); ?> WIB</div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div>
                        ...
                        ?>
                        <span class="badge <?php echo e($isPerluPerhatian ? 'bg-danger' : 'bg-success'); ?> px-3 py-2">
            ...
            <div class="p-3 bg-light rounded-3 mb-3">
                ...
                <div class="mb-2">
                    ...
                    <div class="fw-semibold"><?php echo e($examination->student->nis ?? '-'); ?></div>
                </div>

                <div class="mb-2">
                    <label class="form-label small text-muted">Nama Lengkap</label>
                    <div class="fw-semibold"><?php echo e($examination->student->full_name ?? '-'); ?></div>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div>
                        <span class="badge bg-light text-dark border px-3 py-2">
                            <?php echo e($examination->student->class->name ?? '-'); ?>
            ...
            <!-- Informasi Petugas -->
            <div class="p-3 bg-light rounded-3 mb-3">
                <h6 class="fw-bold text-info mb-3"><i class="fas fa-user-nurse me-2"></i>Petugas Piket</h6>
                
                <div class="mb-2">
                    <label class="form-label small text-muted">Kelompok Piket</label>
                    <div class="fw-semibold"><?php echo e($examination->piket_group ?? '-'); ?></div>
                </div>

                <div class="mb-2">
                    <label class="form-label small text-muted">Nama Petugas</label>
                    <div class="fw-semibold"><?php echo e($examination->officer_name ?? '-'); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-7">
            <!-- Diagnosa & Pengobatan -->
            <div class="p-3 bg-light rounded-3 mb-3">
                <h6 class="fw-bold text-danger mb-3"><i class="fas fa-notes-medical me-2"></i>Diagnosa & Pengobatan</h6>
                ...
                <div class="mb-3">
                    ...
                    <div class="p-3 bg-white rounded border">
                        <?php echo e($examination->medicine ?? '-'); ?>
            ...
            <div class="p-3 bg-light rounded-3 mb-3">
                <h6 class="fw-bold text-warning mb-3"><i class="fas fa-camera me-2"></i>Dokumentasi Foto</h6>
                <div class="text-center">
                    <img src="<?php echo e(asset('storage/' . $examination->photo)); ?>" alt="Foto Kunjungan" 
            ...
            <div class="p-3 bg-light rounded-3">
                <h6 class="fw-bold text-secondary mb-3"><i class="fas fa-clock me-2"></i>Informasi Sistem</h6>
                
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label small text-muted">Waktu Dibuat</label>
                        <div class="fw-semibold"><?php echo e($examination->created_at->format('d/m/Y H:i')); ?></div>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label small text-muted">Terakhir Diubah</label>
                        <div class="fw-semibold"><?php echo e($examination->updated_at->format('d/m/Y H:i')); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.petugas', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sikes\resources\views/petugas/examinations/show.blade.php ENDPATH**/ ?>