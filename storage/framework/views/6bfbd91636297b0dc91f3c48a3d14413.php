                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <?php $aboutPageImage = $settings['about_page_image'] ?? ''; ?>
                ...
                <div class="card border-0 shadow-sm mb-3">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="form-label fw-semibold">Label Kecil (Badge)</label>
                                <input type="text" name="faq_label" class="form-control" value="<?php echo e($settings['faq_label'] ?? 'FAQ'); ?>">
                            </div>
                            <div class="col-md-8">
                                <label class="form-label fw-semibold">Judul Section</label>
                                <input type="text" name="faq_title" class="form-control" value="<?php echo e(strip_tags($settings['faq_title'] ?? 'Pertanyaan yang Sering Diajukan')); ?>">
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Subjudul / Deskripsi Section</label>
                                <textarea name="faq_subtitle" class="form-control" rows="2"><?php echo e($settings['faq_subtitle'] ?? 'Temukan jawaban atas pertanyaan umum seputar layanan UKS dan penggunaan aplikasi SIKES di sekolah kita.'); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="faq-row border rounded p-3 mb-3 bg-light position-relative">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="faqs[<?php echo e($index); ?>][question]" class="form-control" value="<?php echo e($faq['question'] ?? ''); ?>" placeholder="Contoh: Apakah data saya aman?">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label small fw-bold">Jawaban</label>
                                            <textarea name="faqs[<?php echo e($index); ?>][answer]" class="form-control" rows="3" placeholder="Jelaskan jawabannya di sini..."><?php echo e($faq['answer'] ?? ''); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<script>
    ...
    let faqIndex = <?php echo e($initialFaqCount ?? 1); ?>;
