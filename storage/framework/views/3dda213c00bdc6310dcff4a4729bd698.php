...
<div class="content-card">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('petugas.examinations.recap')); ?>" class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="number" name="year" class="form-control" value="<?php echo e(old('year', $year)); ?>" 
                           min="2020" max="<?php echo e(date('Y') + 1); ?>" required style="border-color: #fecaca;"
                ...
                <div class="col-md-4">
                    ...
                    <select name="month" class="form-select" style="border-color: #fecaca;">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($m = 1; $m <= 12; $m++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <option value="<?php echo e($m); ?>" <?php echo e((int)$month == (int)$m ? 'selected' : ''); ?>>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalVisits > 0): ?>
                ...
                <div class="stat-card" style="border-left-color: #ef4444;">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 style="color: #ef4444 !important; font-family: 'Poppins', sans-serif;"><?php echo e(number_format($totalVisits)); ?></h3>
                            <small class="text-muted">
                                <i class="fas fa-calendar-alt me-1"></i>
                                Periode: Tahun <?php echo e($year); ?> <?php echo e($month ? '- ' . \Carbon\Carbon::createFromDate($year, $month, 1)->format('F') : '(Semua Bulan)'); ?>
        ...
        <div class="card mb-4" style="border: 1px solid #fee2e2; border-radius: 16px;">
            <div class="card-header bg-white border-0 pt-3 pb-0">
                <h6 class="mb-0 fw-bold" style="color: #991b1b;">
                    ...
                    Grafik Kunjungan per Bulan (Tahun <?php echo e($year); ?>)
                </h6>
            </div>
            <div class="card-body">
    ...
    <?php else: ?>
        ...
        <div class="text-center py-5">
            ...
            <p class="text-muted mb-0" style="max-width: 500px; margin: 0 auto; line-height: 1.6;">
                Belum ada data kunjungan untuk tahun <strong><?php echo e($year); ?></strong> <?php echo e($month ? 'pada bulan <strong>' . \Carbon\Carbon::createFromDate($year, $month, 1)->format('F') . '</strong>' : ''); ?>.
