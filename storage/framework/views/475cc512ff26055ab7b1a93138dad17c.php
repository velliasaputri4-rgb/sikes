...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        <div class="container">
            <a class="navbar-brand" href="<?php echo e(route('landing')); ?>">
                <img src="<?php echo e(asset('images/logo sikes navbar.png')); ?>" alt="Logo SIKES" style="max-height: 55px;">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center gap-1">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?php echo e(route('landing.about')); ?>">Tentang</a></li>
    ...
    <header class="page-header">
        <div class="container position-relative" data-aos="fade-up">
            ...
            <p class="section-subtitle mx-auto"><?php echo e($headerSubtitle); ?></p>
        </div>
    </header>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    ?>
                    <img src="<?php echo e($imgSrc); ?>" alt="Tentang SIKES" class="img-fluid rounded-4 shadow-lg" style="width: 100%; object-fit: cover;">
                </div>
            ...
            <div class="row g-4">
                <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="vm-card">
                        ...
                        <p style="color: var(--slate); line-height: 1.8;"><?php echo e($vision); ?></p>
                    </div>
                </div>
    ...
    <section class="section" style="background: var(--gradient-primary); color: white; text-align: center;">
        <div class="container" data-aos="zoom-in">
            <h2 class="fw-bold mb-3" style="font-family: 'Poppins', sans-serif;"><?php echo e($ctaTitle); ?></h2>
            <p class="mb-4" style="max-width: 600px; margin: 0 auto 30px; opacity: 0.9;"><?php echo e($ctaDesc); ?></p>
            <a href="<?php echo e(route('landing')); ?>#layanan" class="btn btn-light text-primary fw-bold px-4 py-3 rounded-3 shadow-lg" style="text-decoration: none;">
                <i class="fas fa-arrow-right me-2"></i> <?php echo e($ctaBtn); ?>
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    ...
                    <p style="color: rgba(255,255,255,0.7); line-height: 1.8;">
                        <?php echo e(\App\Models\Setting::get('footer_desc', 'Sistem Informasi Unit Kesehatan Sekolah modern dan terpercaya.')); ?>
                ...
                <div class="col-6 col-lg-3">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li><a href="<?php echo e(route('landing.health-info')); ?>"><i class="fas fa-chevron-right fa-xs"></i> Info Kesehatan</a></li>
                ...
                <div class="col-lg-3">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li><a href="<?php echo e(\App\Models\Setting::get('contact_ig_link', 'https://instagram.com/pmrwira_eskasaba')); ?>" target="_blank"><i class="fab fa-instagram"></i> <?php echo e('@' . \App\Models\Setting::get('contact_ig_handle', 'pmrwira_eskasaba')); ?></a></li>
                    </ul>
                </div>
            </div>
...
</html><?php /**PATH C:\laragon\www\sikes\resources\views/landing/about.blade.php ENDPATH**/ ?>