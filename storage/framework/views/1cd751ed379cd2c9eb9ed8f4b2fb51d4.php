...
<?php $__env->startSection('page-title', 'Edit Data Obat'); ?>

<?php $__env->startSection('content'); ?>
    <div class="content-card">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h5 class="fw-bold mb-0"><i class="fas fa-edit me-2 text-warning"></i>Edit Data Obat</h5>
            <a href="<?php echo e(route('petugas.medicines.index')); ?>" class="btn btn-outline-secondary btn-sm">
                <i class="fas fa-arrow-left me-1"></i> Kembali ke Daftar
            </a>
        </div>

        <form action="<?php echo e(route('petugas.medicines.update', $medicine->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('code', $medicine->code)); ?>" placeholder="Contoh: OBT-001" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name', $medicine->name)); ?>" placeholder="Contoh: Paracetamol 500mg" required>
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="Contoh: Untuk meredakan demam, sakit kepala, dan nyeri ringan"><?php echo e(old('description', $medicine->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('stock', $medicine->stock)); ?>" min="0" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('minimum_stock', $medicine->minimum_stock)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <option value="<?php echo e($unit); ?>" <?php echo e(old('unit', $medicine->unit) == $unit ? 'selected' : ''); ?>>
                                <?php echo e($unit); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('expired_date', $medicine->expired_date ? \Carbon\Carbon::parse($medicine->expired_date)->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="d-flex justify-content-end mt-4 pt-3 border-top">
                <a href="<?php echo e(route('petugas.medicines.index')); ?>" class="btn btn-outline-secondary me-2">Batal</a>
...
<?php echo $__env->make('layouts.petugas', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sikes\resources\views/petugas/medicines/edit.blade.php ENDPATH**/ ?>