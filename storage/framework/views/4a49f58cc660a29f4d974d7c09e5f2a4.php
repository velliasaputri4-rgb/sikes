...
<?php $__env->startSection('content'); ?>
    <style>
        ...
        .page-head h5 .head-icon { 
            ...
            font-size: 15px; box-shadow: 0 4px 10px rgba(239, 68, 68, 0.3); 
        }
        
        .filter-card { 
            background: #ffffff; border: 1px solid #fee2e2; border-radius: 12px; 
            padding: 16px; margin-bottom: 20px; box-shadow: 0 2px 8px rgba(239, 68, 68, 0.04); 
        }
        .filter-card .form-control { border-color: #fecaca; }
        ...
        .table thead th { 
            background: #fef2f2; color: #991b1b; font-weight: 700; font-size: 11px; 
            text-transform: uppercase; letter-spacing: 0.8px; border-bottom: 2px solid #fecaca; 
        }
        ...
        .badge-group { 
            ...
            font-weight: 600; font-size: 0.85rem; display: inline-flex; align-items: center; gap: 4px;
        ...
        .btn-aksi-edit:hover { transform: translateY(-2px); box-shadow: 0 4px 12px rgba(245, 158, 11, 0.4); color: white; }
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                ...
                                <p class="mb-0 fw-semibold" style="color: #475569;">Belum ada data grup petugas</p>
            ...
            <div class="modal-content" style="border: none; border-radius: 16px; overflow: hidden;">
                <div class="modal-header" style="background: #fef2f2; border-bottom: 1px solid #fee2e2;">
                    <h5 class="modal-title fw-bold">
                        <i class="fas fa-plus-circle me-2" style="color: #ef4444;"></i>Tambah Grup Piket
                    </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="membersContainer">
                                <div class="member-input mb-2 p-2 rounded">
                            ...
                            <button type="button" class="btn btn-sm w-100 mt-2" style="background: #fef2f2; color: #991b1b; border: 1px solid #fecaca;" onclick="addMember()">
                                <i class="fas fa-plus me-1"></i>Tambah Anggota
                            </button>
                        </div>
                    </div>
                    <div class="modal-footer" style="background: #fef2f2; border-top: 1px solid #fee2e2;">
                        <button type="button" class="btn" style="background: #f1f5f9; color: #475569; border: 1px solid #cbd5e1;" data-bs-dismiss="modal">Batal</button>
    ...
    <div class="modal fade" id="modalEdit" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border: none; border-radius: 16px; overflow: hidden;">
                <div class="modal-header" style="background: #fef2f2; border-bottom: 1px solid #fee2e2;">
                    <h5 class="modal-title fw-bold">
                        <i class="fas fa-edit me-2" style="color: #ef4444;"></i>Edit Grup Piket
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="editForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <button type="button" class="btn btn-sm w-100 mt-2" style="background: #fef2f2; color: #991b1b; border: 1px solid #fecaca;" onclick="addEditMember()">
                                <i class="fas fa-plus me-1"></i>Tambah Anggota
                            </button>
                        </div>
                    </div>
    ...
    <script>
        ...
        function addMember() {
            ...
            div.className = 'member-input mb-2 p-2 rounded';
            div.innerHTML = `
                <div class="row g-2 align-items-end">
                    <div class="col-6">
                    ...
                    <div class="col-12 text-end">
                        <button type="button" class="btn btn-sm" style="background: #fef2f2; color: #991b1b; border: 1px solid #fecaca;" onclick="this.closest('.member-input').remove()">
