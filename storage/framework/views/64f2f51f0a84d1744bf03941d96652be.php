...
unset($__errorArgs, $__bag); ?>" 
                      ...
                      style="border-color: #fecaca;"><?php echo e(old('content', $healthTip->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="d-flex gap-2 pt-3" style="border-top: 1px solid #fee2e2;">
            ...
            <a href="<?php echo e(route('petugas.health-tips.index')); ?>" class="btn" style="background: #f1f5f9; color: #475569; border: 1px solid #cbd5e1;">
