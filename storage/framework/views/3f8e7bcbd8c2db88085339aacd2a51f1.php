...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center gap-1">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('landing.docs')); ?>" class="btn-doc-all">Dokumentasi</a></li>
    ...
    <section class="hero-section" id="beranda">
        ...
        <div class="hero-photo">
            <img src="<?php echo e(asset('images/hero-sekolah.png')); ?>" alt="Gedung SMK Negeri 1 Bangsri">
        </div>
            ...
            <div class="row g-3 g-md-4 mt-4 mt-md-5 justify-content-center">
                <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="0">
                    <a href="<?php echo e(auth()->check() && auth()->user()->hasRole('siswa') ? route('siswa.history') : route('login.siswa')); ?>" class="menu-card">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!auth()->check() || !auth()->user()->hasRole('siswa')): ?>
                        ...
                        <div class="doc-card">
                            <div class="doc-image">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($doc->video_link)): ?>
                                    <a href="<?php echo e($doc->video_link); ?>" 
                                       target="_blank" 
                                       class="video-overlay" 
                                       title="Putar Video">
                            ...
                            <div class="doc-content">
                                ...
                                <h5 class="doc-title">
                                    <a href="<?php echo e(!empty($doc->video_link) ? $doc->video_link : route('landing.docs-detail', \Illuminate\Support\Str::slug($doc->title))); ?>" 
                                       target="<?php echo e(!empty($doc->video_link) ? '_blank' : '_self'); ?>">
                                        <?php echo e(\Illuminate\Support\Str::limit($doc->title, 65)); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($doc->excerpt)): ?>
                                    <p class="doc-excerpt"><?php echo e(\Illuminate\Support\Str::limit($doc->excerpt, 90)); ?></p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="address-text">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $addressLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim($line) !== ''): ?>
                                    <div class="address-line"><?php echo e(e(trim($line))); ?></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="info-card">
                        ...
                        <p style="color: var(--slate); line-height: 2; margin-bottom: 0;">
                            ...
                            <a href="<?php echo e(\App\Models\Setting::get('contact_ig_link', 'https://instagram.com/pmrwira_eskasaba')); ?>" target="_blank" style="color: var(--ink); text-decoration: none; font-weight: 600;">
                                <?php echo e('@' . \App\Models\Setting::get('contact_ig_handle', 'pmrwira_eskasaba')); ?>

                            </a><br>
                            <i class="fab fa-youtube me-2 text-danger"></i>
                            <a href="<?php echo e(\App\Models\Setting::get('contact_yt_link', 'https://youtube.com/@wirasandyaadhimukti3463')); ?>" target="_blank" style="color: var(--ink); text-decoration: none; font-weight: 600;">
                                <?php echo e('@' . \App\Models\Setting::get('contact_yt_handle', 'wirasandyaadhimukti3463')); ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.addEventListener("scroll", function() {
                ...
                navLinks.forEach((link) => {
                    ...
                    } else if (current === "" && (link.getAttribute("href") === "<?php echo e(route('landing')); ?>" || link.getAttribute("href") === "#beranda")) {
                        link.classList.add("active");
                    }
                });
            }, { passive: true });
...
</html><?php /**PATH C:\laragon\www\sikes\resources\views/welcome.blade.php ENDPATH**/ ?>