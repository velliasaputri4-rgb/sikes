...
<body class="d-flex flex-column min-vh-100">
            ...
            <div class="row g-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    <div class="col-12 text-center py-5" data-aos="fade-up">
                        ...
                        <a href="<?php echo e(route('landing')); ?>" class="btn btn-primary mt-3">Kembali ke Beranda</a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($documentations) && $documentations->isNotEmpty()): ?>
                <div class="text-center mt-5" data-aos="fade-up">
                    <a href="<?php echo e(route('landing')); ?>#dokumentasi" class="btn btn-outline-primary px-4 py-2 rounded-pill fw-bold">
    ...
    <footer>
        <div class="container">
            <p class="mb-0"><?php echo \App\Models\Setting::get('footer_copyright', '&copy; ' . date('Y') . ' <strong>SIKES</strong> - Sistem Informasi UKS. All rights reserved.'); ?></p>
        </div>
    </footer>
